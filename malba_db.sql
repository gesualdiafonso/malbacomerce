...
-- Tiempo de generación: 28-06-2025 a las 00:39:12
...
--
-- Estructura de tabla para la tabla `curadoria_usuario`
--
...
--
-- Estructura de tabla para la tabla `detalles_artista`
--
...
--
-- Volcado de datos para la tabla `detalles_artista`
--
...
--
-- Estructura de tabla para la tabla `galeria_tecnica`
--
...
--
-- Volcado de datos para la tabla `galeria_tecnica`
--
...
--
-- Indices de la tabla `curadoria_usuario`
--
...
--
-- Indices de la tabla `detalles_artista`
--
...
--
-- Indices de la tabla `galeria_tecnica`
--
...
--
-- AUTO_INCREMENT de la tabla `curadoria_usuario`
--
ALTER TABLE `curadoria_usuario`
  MODIFY `id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de la tabla `detalles_artista`
--
ALTER TABLE `detalles_artista`
...
--
-- AUTO_INCREMENT de la tabla `galeria_tecnica`
--
ALTER TABLE `galeria_tecnica`
...
--
-- Filtros para la tabla `galeria_tecnica`
--
ALTER TABLE `galeria_tecnica`
